...
export default class VisualManager {
    ...
    drawTable() {
        ...
        const tableBase = new Polygon(G.TABLE_MAIN_COLOR, false, G.CTX, new Vector2(0, 0), new Vector2(G.TABLE_WIDTH, 0), new Vector2(G.TABLE_WIDTH, G.TABLE_HEIGHT), new Vector2(0, G.TABLE_HEIGHT));
        tableBase.draw();
