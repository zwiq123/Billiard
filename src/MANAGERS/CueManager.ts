...
export default class CueManager{
    ...
    private getPullDistance(cursorPos: Vector2): number {
    ...
    private getBallHitForce(): Vector2 {
    ...
    private drawCollisionLines(hitBall: Circle, collisionPoint: Vector2): void {
        ...
        const targetSeg = new Segment(
            collisionPoint,
            Vector2.add(collisionPoint, Vector2.multiplyByNum(normal, targetLen)),
            G.CTX!
        );
        ...
        const whiteSeg = new Segment(
            collisionPoint,
            Vector2.add(collisionPoint, Vector2.multiplyByNum(whitePostDir, whiteLen)),
            G.CTX!
        );
